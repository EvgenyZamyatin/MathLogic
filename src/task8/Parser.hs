...
happyReduction_1 (HappyAbsSyn5  happy_var_3)
	...
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn4
		 (O (happy_var_1, 1) (O (happy_var_3, 1) (A 0))
	)
...
happyReduction_2 (HappyAbsSyn6  happy_var_3)
	...
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn5
		 (addOrd happy_var_1 happy_var_3
	)
...
happyReduction_4 (HappyAbsSyn7  happy_var_3)
	...
	(HappyAbsSyn6  happy_var_1)
	 =  HappyAbsSyn6
		 (mulOrd happy_var_1 happy_var_3
	)
...
happyReduction_6 (HappyAbsSyn7  happy_var_3)
	...
	(HappyAbsSyn8  happy_var_1)
	 =  HappyAbsSyn7
		 (expOrd happy_var_1 happy_var_3
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TokenConst happy_dollar_dollar -> cont 9;
	TokenPlus -> cont 10;
	TokenMul -> cont 11;
	TokenPow -> cont 12;
	TokenCB -> cont 13;
